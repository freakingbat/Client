...
/**
 * Этот класс собирает окно входа,
 * перенаправляет на окна регистрации, меню или 
...
public class EnterInterface extends JFrame {
   ...
   final WebPasswordField passwordField = new WebPasswordField(15);
    ...
    button_enter.addActionListener((ActionEvent e) -> {
          try {
              Service.getLoginService().logIn(loginField.getText(), new String(passwordField.getPassword()));
              new PageInterface();
              setVisible(false);
    ...
    button_registration.addActionListener(new ActionListener() {
     @Override
      /**
      * Этот метод вызывает окно регистрации при нажатии кнопки
      */
    ...
    forgotten_password.addActionListener(new ActionListener() {
     @Override
     /**
